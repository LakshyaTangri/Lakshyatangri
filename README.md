...
| 10TB+     | Parquet, graph data | Python / SQL     | MSK (Kafka), AWS DMS (CDC), Kinesis Data Streams | Graph + Lakehouse / Analytical | Amazon Neptune (Graph), Amazon Redshift | Amazon S3 (+ S3 Glacier for archive) | Amazon EMR, AWS Glue, Amazon EC2, Trino/Presto on EMR or EKS |
